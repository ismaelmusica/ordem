            ...
            <div class="card-body">
                ...
                <form class="user" method="POST" name="form_edit">
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-md-3">
                            <label>CNPJ</label>
                            <input type="text" class="form-control form-control-user cnpj" name="sistema_cnpj" placeholder="CPNJ" value="<?php echo $sistema->sistema_cnpj;     ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-1">
                            <label>Nº</label>
                            <input type="text" class="form-control form-control-user" name="sistema_numero" placeholder="Nº" value="<?php echo $sistema->sistema_numero; ?>">
